...
import type { MixedStyleRecord, Node, TNode, TText, TPhrasing, DocumentContext as TREDocumentContext, TDocument, DomVisitorCallbacks, SetMarkersForTNode, HTMLContentModel, CustomElementModel, HTMLElementModel, TRenderEngineOptions, NodeWithChildren, Element, Document, NativeTextStyles, NativeBlockStyles } from '@native-html/transient-render-engine';
import type { CounterStyleRenderer } from '@jsamr/counter-style';
import type { ComponentType, ReactElement, ReactNode } from 'react';
import type { CSSPropertyNameList, MixedStyleDeclaration } from '@native-html/css-processor';
 ...
 * @public
 */
export declare type HTMLElementModelRecord = Record<string, CustomElementModel<string, HTMLContentModel> | HTMLElementModel<string, HTMLContentModel>>;
/**
 * @public
 */
 ...
 * @typeParam T - The concrete type of {@link TNode}.
 */
export declare type InternalRenderer<T extends TNode> = React.ComponentType<InternalRendererProps<T>>;
/**
 ...
 * @public
 */
export declare type CustomRenderer<T extends TNode> = React.ComponentType<CustomRendererProps<T>>;
/**
