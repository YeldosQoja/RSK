 ...
 * @public
 */
export declare type SetMarkersForTNode = (targetMarkers: Markers, parentMarkers: Readonly<Markers>, tnode: TNodeDescriptor) => void;
/**
 ...
 * @public
 */
export declare type NativeBlockStyles = TStylesShape['nativeBlockFlow'] & TStylesShape['nativeBlockRet'];
/**
 * Processed styles which can be passed to `Text` elements.
 *
 * @public
 */
export declare type NativeTextStyles = TStylesShape['nativeBlockFlow'] & TStylesShape['nativeBlockRet'] & TStylesShape['nativeTextFlow'] & TStylesShape['nativeTextRet'];
/**
 * Processed Web text styles.
 *
 * @public
 */
export declare type WebTextStyles = TStylesShape['webTextFlow'];
/**
 * Processed Web block styles.
 *
 * @public
 */
export declare type WebBlockStyles = TStylesShape['webBlockRet'];
/**
 * @public
 */
export interface TNodeShape<T extends TNodeType> {
     ...
     */
    getNativeStyles(): T extends 'text' | 'phrasing' ? NativeTextStyles : NativeBlockStyles;
    /**
...
export declare type TNode = TBlock | TDocument | TEmpty | TPhrasing | TText;
...
export declare type TNodeType = 'block' | 'phrasing' | 'text' | 'empty' | 'document';
export interface TNodeMethods {
    bindChildren(this: TNodeImpl, children: ReadonlyArray<TNodeImpl>, shouldUpdateNodeIndexes?: boolean): void;
    cloneInitParams<T extends TNodeInit = TNodeInit>(this: TNodeImpl, partial?: Partial<T>): T;
...
export interface TNodeImpl<T = TNodeInit> extends TNodeMethods, Omit<TNodeShape<TNodeType>, 'children' | 'parent'> {
