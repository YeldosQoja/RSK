...
function useHtmlIframeProps({
  ...
  if (__DEV__ && !WebView) {
    console.warn("@native-html/iframe-plugin: You must pass a WebView component from react-native-webview as a prop to the HTML component. The iframe won't be rendered.");
  }

  return WebView ? { ...resolvedConfig,
    key,
    source,
    onLinkPress,
    htmlAttribs,
